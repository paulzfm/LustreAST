...
%token PREFIX PARAMS_TYPES RET_TYPES
...
/* value */
%token TRUE FALSE
%token <string> GUID IDENT COMMENT CONST_INT CONST_FLO CONST_CHAR
%token NULLCOMMENT
...
prefixStmtY:
		PREFIX LPAREN IDENT COMMA PARAMS_TYPES LPAREN kindsY RPAREN COMMA RET_TYPES LPAREN kindsY RPAREN RPAREN
			{FuncStmt($3,$7,$12)}
